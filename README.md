...
# Project Description 📝
NerdForge is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [NerdForge Aim](#NerdForge-aim-)        | 📚 Overview of NerdForge's goals            |
...
## System Architecture 🏰
<br/>
☝ The NerdForge ed-tech platform consists of three main components:  <br/>
...
<br/>
Here is a high-level diagram that illustrates the architecture of the NerdForge ed-tech platform:
...
#### The front end of NerdForge has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Cloud-based Media Management ☁️ :** NerdForge uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of NerdForge uses several data models and database schemas to manage data, including:
