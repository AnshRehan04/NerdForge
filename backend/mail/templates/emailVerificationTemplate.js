	...
	<body>
		<div class="container">
			<a href=""><img class="logo"
					src="https://i.ibb.co/nNzDNphk/Screenshot-2025-05-19-170933.png" alt="NerdForge Logo"></a>
			<div class="message">OTP Verification Email</div>
			<div class="body">
				<p>Dear ${name}</p>
				<p>Thank you for registering with NerdForge. To complete your registration, please use the following OTP
